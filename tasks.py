...
from .Addmodules.MADR import *
from .Addmodules.ConvNeXt import convnextv2_atto, convnextv2_large, convnextv2_base, convnextv2_tiny,convnextv2_femto,convnext_pico, convnextv2_nano, convnextv2_huge
from .Addmodules.RepViT1 import repvit_edge_nano, repvit_edge_micro
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 PSA, SCDown, C2fMLLABlock, MSFM, ModulatedDeformConv2dPack, DCDConv, C2f_WTConv, LDConv, C2f_SCSA1, C2f_SCSA2,C2f_DFF,C2f_MADR,VoVGSCSP_MADR):
            c1, c2 = ch[f], args[0]
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_ACmix, C2f_AKConv,
                     ...
                     C2f_GhostModule_DynamicConv, C2f_UIB, C2fCIB, C2fMLLABlock, MSFM, C2f_WTConv, C2f_SCSA1, C2f_SCSA2,C2f_DFF,C2f_MADR,VoVGSCSP_MADR):
        ...
        # ---------------------------------------主干----------------------------
                   ...
                   repvit_m0_6, repvit_m0_9, repvit_m1_0, repvit_m1_1, repvit_m1_5, repvit_m2_3,repvit_edge_micro,repvit_edge_nano,LSKNet,
                   LSKNET_Tiny,
                   ...
                   convnextv2_atto, convnextv2_large, convnextv2_base, convnextv2_tiny,convnextv2_femto,convnext_pico, convnextv2_nano, convnextv2_huge,
